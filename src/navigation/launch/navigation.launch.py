...
def generate_launch_description():
    ...
    controller_yaml = os.path.join(get_package_share_directory('navigation'), 'config', 'controller.yaml')
    ...
    nav2_yaml = os.path.join(get_package_share_directory('navigation'), 'config', 'amcl_config.yaml')
    map_file = os.path.join(get_package_share_directory('navigation'), 'map', 'maze_map.yaml')
